          ...
          <div className="space-y-8 md:space-y-10 order-2 lg:order-1 text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-4 text-left">
              <div className="space-y-3">
                ...
                <h4 className="text-lg font-black italic uppercase tracking-tight text-center lg:text-left">Our Mission</h4>
              ...
              <div className="space-y-3">
                ...
                <h4 className="text-lg font-black italic uppercase tracking-tight text-center lg:text-left">Our Vision</h4>
                <p className="text-sm text-slate-400 font-medium leading-relaxed text-center lg:text-left">
            ...
            >
              <div className="flex items-center space-x-3 md:space-x-4">
                <div className="h-10 w-10 md:h-12 md:w-12 bg-blue-50 rounded-xl md:rounded-2xl flex items-center justify-center text-[#2563EB]">
                   <span className="text-lg md:text-xl font-black italic">9+</span>
                </div>
                <div>
                  <p className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest">Years of</p>
                  <p className="text-xs md:text-sm font-black text-[#111111] uppercase italic">Excellence</p>
                </div>
              </div>
            </motion.div>
